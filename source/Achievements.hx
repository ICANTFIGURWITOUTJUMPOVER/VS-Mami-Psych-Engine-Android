...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		["No More Witches!",	"Beat Week M on Holy with no Misses.",						'weekm_nomiss',	 false],
		["もうTetrisしかないじゃない",	"Beat Tetris on Holy with no Misses.",						'tetris_nomiss',	 false],
		["Mamigation",	"Beat Mamigation on Holy with no Misses.",						'mamigation_nomiss',	 false]
	];
